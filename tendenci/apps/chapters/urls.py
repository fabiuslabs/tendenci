...
urlpatterns = [
    ...
    re_path(r'^chapters/edit_app_field/(?P<id>\d+)/$', views.edit_app_field, name='chapters.edit_app_field'),
    ...
    re_path(r"^chapters/get_chapter_app_fields/(?P<chapter_id>\d+)/$",
            views.get_chapter_app_fields_json,
            name="get_chapter_app_fields"),
